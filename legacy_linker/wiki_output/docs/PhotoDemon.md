...
graph LR
  Current[PhotoDemon]
  Current --> |Calls| explorerexe[explorer.exe]
  Current --> |Calls| explorerexe[explorer.exe]
  Current --> |Calls| IfyouinsistonrunningPhotoDemonintheIDEpleasedonotsubmitbugsregardingIDEcrashesorfreezesPhotoDemonsdeveloperscanonlyaddressissuesandbugsthataffectthecompiledexe[If you insist on running PhotoDemon in the IDE, please do not submit bugs regarding IDE crashes or freezes.  PhotoDemon's developers can only address issues and bugs that affect the compiled .exe]
  Current --> |Calls| explorerexe[explorer.exe]
  Current --> |Calls| explorerexe[explorer.exe]
  Current --> |Calls| 2ExtractthezipfilescontentstoafolderonyourPCMakesurebothPhotoDemonexe[2) Extract the zip file's contents to a folder on your PC.  Make sure both PhotoDemon.exe]
  Current --> |Calls| 3DoubleclickthenewPhotoDemonexe[3) Double-click the new PhotoDemon.exe]
  Current --> |Calls| ShellCall[Shell_Call]
  Current --> |Calls| ShellCall[Shell_Call]
  Current --> |Calls| exiftoolexe[exiftool.exe]
  Current --> |Calls| exiftoolexe[exiftool.exe]
  Current --> |Calls| exiftoolexe[exiftool.exe]
  Current --> |Calls| exiftoolexe[exiftool.exe]
  Current --> |Calls| exiftoolexe[exiftool.exe]
  ...
  Current --> |Calls| avifdecexe[avifdec.exe]
  Current --> |Calls| avifdecexe[avifdec.exe]
  Current --> |Calls| avifencexe[avifenc.exe]
  Current --> |Calls| avifencexe[avifenc.exe]
  Current --> |Calls| avifencexe[avifenc.exe]
  Current --> |Calls| avifdecexe[avifdec.exe]
  Current --> |Calls| avifdecexe[avifdec.exe]
  ...
  Current --> |Calls| ShellCall[Shell_Call]
  Current --> |Calls| ShellCall[Shell_Call]
  Current --> |Calls| texdiagexe[texdiag.exe]
  Current --> |Calls| texconvexe[texconv.exe]
  Current --> |Calls| texconvexe[texconv.exe]
  Current --> |Calls| texconvexe[texconv.exe]
  Current --> |Calls| texconvexe[texconv.exe]
  Current --> |Calls| texconvexe[texconv.exe]
  ...
  Current --> |Calls| ShellCall[Shell_Call]
  Current --> |Calls| ShellCall[Shell_Call]
  Current --> |Calls| heifencexe[heif-enc.exe]
  Current --> |Calls| djxlexe[djxl.exe]
  Current --> |Calls| cjxlexe[cjxl.exe]
  Current --> |Calls| jxlinfoexe[jxlinfo.exe]
  Current --> |Calls| djxlexe[djxl.exe]
  Current --> |Calls| djxlexe[djxl.exe]
  Current --> |Calls| djxlexe[djxl.exe]
  Current --> |Calls| cjxlexe[cjxl.exe]
  ...
  Current --> |Calls| djxlexe[djxl.exe]
  Current --> |Calls| djxlexe[djxl.exe]
  Current --> |Calls| failedtoshelldecoderdjxlexe[failed to shell decoder (djxl.exe]
  Current --> |Calls| jxlinfoexe[jxlinfo.exe]
  Current --> |Calls| jxlinfoexe[jxlinfo.exe]
  Current --> |Calls| djxlexe[djxl.exe]
  Current --> |Calls| djxlexe[djxl.exe]
  ...
  Current --> |Calls| PDUpdatePatcher[PD_Update_Patcher]
  Current --> |Calls| PDUpdatePatcher[PD_Update_Patcher]
  Current --> |Calls| ShellCall[Shell_Call]
  Current --> |Calls| ShellCall[Shell_Call]
  Current --> |Calls| ShellCall[Shell_Call]
